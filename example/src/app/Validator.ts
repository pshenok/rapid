...
extensions.push(
	(joi: any): Joi.Extension => {
		return {
			...
			language: {
				password:
					"must be at least 6 characters, must contain at least one lowercase and one uppercase letter and one digit. " +
...
const validator = extensions.reduce(
